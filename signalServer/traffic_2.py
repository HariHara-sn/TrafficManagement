...
resize_scale = 0.5  # Adjust scale, keep a higher scale for better detection
...
cv2.line(masked_img, (roi_pts[0][0], line_5m_y), (roi_pts[3][0], line_5m_y), (255, 0, 0), 2)  # Blue line for 5 meters
cv2.line(masked_img, (roi_pts[1][0], line_10m_y), (roi_pts[2][0], line_10m_y), (255, 0, 0), 2)  # Blue line for 10 meters
cv2.line(masked_img, (roi_pts[1][0], line_15m_y), (roi_pts[2][0], line_15m_y), (255, 0, 0), 2)  # Blue line for 15 meters
...
# Show the image with bounding boxes, blue lines, and trape zoid region
